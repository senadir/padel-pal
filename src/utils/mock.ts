...
function generateMockSession(): Session {
...
function generateMockMatches(session: Session): Array<Match> {
  return session.timeSlots.flatMap((slot) =>
...
// Export functions instead of pre-generated data
export function getMockSession(): Session {
  return generateMockSession()
}

export function getMockMatches(): Array<Match> {
  const session = generateMockSession()
  return generateMockMatches(session)
}

// Note: The old exports mockSession and mockMatches are no longer available
// Use getMockSession() and getMockMatches() functions instead
